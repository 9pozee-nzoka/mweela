...
import { PasswordResetComponent } from './components/general/password-reset/password-reset.component';
...
export const routes: Routes = [
  ...
  { path: 'reset-password/:token', component: BoardingComponent }, // ✅ token auto-handled
